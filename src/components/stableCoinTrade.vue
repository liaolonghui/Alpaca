      ...
      <div class="trade-content">
        ...
        <div v-else-if="tradeType === 'addLiquidity'" class="add-liquidity">
          ...
          <div class="add-liquidity-content">
            ...
            <div class="swap-to">
              <div class="to-header">
                ...
                <div>
                  Balance:
                  <span class="trade-token-balance">
                    {{ input3.balance >= 0 ? input3.balance : '-' }}
                  </span>
                </div>
              </div>
              <div class="to-input">
                <input
                  v-model="input3Amount"
                  placeholder="0.0"
                  min="0"
                  @focus="input3CanChange = false"
                  @blur="input3CanChange = true"
                />
                <span
                  v-if="input3.name"
                  @click="getMax('input3')"
                  v-show="input3Amount !== input3.balance"
                  class="to-max"
                >Max</span>
                <!-- token -->
                <span @click="showSelectTokenModal('input3')" class="token-info">
                  <img class="token-icon" v-if="input3.icon" :src="input3.icon" alt="token icon" width="24" height="24">
                  {{ input3.name || 'Select a currency' }}
                  <i class="iconfont icon-expand-more"></i>
                </span>
              </div>
            </div>
            <!-- approve input1与input2和input3 -->
            <div
            ...
            <div
              @click="approve('input3')"
              v-if="input3Approve && input3.name && input3Amount"
              class="swap-button btn btn-success btn-block"
            >
              Approve {{input3.name}}
            </div>
            ...
            <div
              ...
              v-if="!input1Approve
                    ...
                    &&
                    new Number(input3Amount)<=new Number(input3.balance)"
              class="swap-button btn btn-success btn-block"
            >
              Supply
            </div>
            ...
            >
              {{
                (new Number(input1Amount)>=new Number(input1.balance)) || (new Number(input2Amount)>=new Number(input2.balance)) || (new Number(input3Amount)>=new Number(input3.balance))
                ?
...
export default {
  data() {
    ...
    return {
      ...
      // stableAddr
      stableAddr: '0xd46BA4A50594d74a8055Bd3bA5EFbDb0e5e5a9D9',
