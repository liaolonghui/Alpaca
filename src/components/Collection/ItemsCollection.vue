<template>
  <div class="items-collection">
    <header>
      <img :src="collection.img" class="collection-img" />
      <div class="info">
...
.items-collection .info {
  display: flex;
  flex-direction: column;
  justify-content: space-between;
}
.items-collection .collection-img {
  width: 180px;
  height: 180px;
  margin-right: 30px;
  border-radius: 50%;
